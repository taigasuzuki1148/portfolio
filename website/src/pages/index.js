...
export default function Home() {
	...
	return (
		...
		>
			<Hero
				title='Hello :)  I am Taiga Suzuki'
				subtitle='A graduate student at Science Tokyo'
				buttonLabel='Discover my works'
			...
			<ImageAndText
				title='Enjoy discovering the mysteries, but obey the math'
